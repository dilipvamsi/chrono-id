...
int main() {
    ...
    {
        std::cout << "  Testing chrono32bs with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(0, 1110U, 50, 801U, 0U);
        auto tmp = Chrono32bs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32bs::from_persona_units(tmp.get_timestamp(), 291ULL, 0ULL, p);
        assert(obj.value == 0x32e6014ULL);
        assert(obj.formatted() == "032E-6014");
    }
    {
        std::cout << "  Testing chrono32d with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(1, 1111U, 51, 802U, 10U);
        auto tmp = Chrono32d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32d::from_persona_units(tmp.get_timestamp(), 292ULL, 73ULL, p);
        assert(obj.value == 0x134f1efULL);
        assert(obj.formatted() == "0134-F1EF");
    }
    {
        std::cout << "  Testing chrono32h with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(2, 1112U, 52, 803U, 11U);
        auto tmp = Chrono32h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32h::from_persona_units(tmp.get_timestamp(), 293ULL, 10ULL, p);
        assert(obj.value == 0xe7a56aULL);
        assert(obj.formatted() == "00E7-A56A");
    }
    {
        std::cout << "  Testing chrono32hy with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(3, 1113U, 53, 804U, 1932U);
        auto tmp = Chrono32hy::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32hy::from_persona_units(tmp.get_timestamp(), 294ULL, 459ULL, p);
        assert(obj.value == 0x1a75bd1ULL);
        assert(obj.formatted() == "01A7-5BD1");
    }
    {
        std::cout << "  Testing chrono32m with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(4, 1114U, 54, 805U, 1U);
        auto tmp = Chrono32m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32m::from_persona_units(tmp.get_timestamp(), 295ULL, 0ULL, p);
        assert(obj.value == 0xd92ab6ULL);
        assert(obj.formatted() == "00D9-2AB6");
    }
    {
        std::cout << "  Testing chrono32mo with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(5, 1115U, 55, 806U, 910U);
        auto tmp = Chrono32mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32mo::from_persona_units(tmp.get_timestamp(), 296ULL, 461ULL, p);
        assert(obj.value == 0x141cd45ULL);
        assert(obj.formatted() == "0141-CD45");
    }
    {
        std::cout << "  Testing chrono32q with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(6, 1116U, 56, 807U, 1935U);
        auto tmp = Chrono32q::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32q::from_persona_units(tmp.get_timestamp(), 297ULL, 462ULL, p);
        assert(obj.value == 0x1ac6bb0ULL);
        assert(obj.formatted() == "01AC-6BB0");
    }
    {
        std::cout << "  Testing chrono32tm with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(7, 1117U, 57, 808U, 0U);
        auto tmp = Chrono32tm::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32tm::from_persona_units(tmp.get_timestamp(), 298ULL, 15ULL, p);
        assert(obj.value == 0x15b77f5ULL);
        assert(obj.formatted() == "015B-77F5");
    }
    {
        std::cout << "  Testing chrono32w with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(8, 1118U, 58, 809U, 401U);
        auto tmp = Chrono32w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32w::from_persona_units(tmp.get_timestamp(), 299ULL, 464ULL, p);
        assert(obj.value == 0x160f680ULL);
        assert(obj.formatted() == "0160-F680");
    }
    {
        std::cout << "  Testing chrono32y with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(9, 1119U, 59, 810U, 1938U);
        auto tmp = Chrono32y::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32y::from_persona_units(tmp.get_timestamp(), 300ULL, 465ULL, p);
        assert(obj.value == 0x1c69c53ULL);
        assert(obj.formatted() == "01C6-9C53");
    }
    {
        std::cout << "  Testing chrono64cs with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(10, 1120U, 60, 811U, 1939U);
        auto tmp = Chrono64cs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64cs::from_persona_units(tmp.get_timestamp(), 301ULL, 466ULL, p);
        assert(obj.value == 0x13e1d87d62d1926ULL);
        assert(obj.formatted() == "013E-1D87-D62D-1926");
    }
    {
        std::cout << "  Testing chrono64d with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(11, 1121U, 61, 812U, 1940U);
        auto tmp = Chrono64d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64d::from_persona_units(tmp.get_timestamp(), 302ULL, 467ULL, p);
        assert(obj.value == 0x134ea78d7abdc1bULL);
        assert(obj.formatted() == "0134-EA78-D7AB-DC1B");
    }
    {
        std::cout << "  Testing chrono64ds with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(12, 1122U, 62, 813U, 1941U);
        auto tmp = Chrono64ds::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64ds::from_persona_units(tmp.get_timestamp(), 303ULL, 468ULL, p);
        assert(obj.value == 0x1fcfc0c8a20fb66ULL);
        assert(obj.formatted() == "01FC-FC0C-8A20-FB66");
    }
    {
        std::cout << "  Testing chrono64h with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(13, 1123U, 63, 814U, 1942U);
        auto tmp = Chrono64h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64h::from_persona_units(tmp.get_timestamp(), 304ULL, 469ULL, p);
        assert(obj.value == 0x1cf4b6a32670b99ULL);
        assert(obj.formatted() == "01CF-4B6A-3267-0B99");
    }
    {
        std::cout << "  Testing chrono64m with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(14, 1124U, 64, 815U, 1943U);
        auto tmp = Chrono64m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64m::from_persona_units(tmp.get_timestamp(), 305ULL, 470ULL, p);
        assert(obj.value == 0x1b25563077499ceULL);
        assert(obj.formatted() == "01B2-5563-0774-99CE");
    }
    {
        std::cout << "  Testing chrono64mo with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(15, 1125U, 65, 816U, 1944U);
        auto tmp = Chrono64mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64mo::from_persona_units(tmp.get_timestamp(), 306ULL, 471ULL, p);
        assert(obj.value == 0x142de904ee77837ULL);
        assert(obj.formatted() == "0142-DE90-4EE7-7837");
    }
    {
        std::cout << "  Testing chrono64ms with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(16, 1126U, 66, 817U, 921U);
        auto tmp = Chrono64ms::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64ms::from_persona_units(tmp.get_timestamp(), 307ULL, 472ULL, p);
        assert(obj.value == 0x18da4e9cbb59c12ULL);
        assert(obj.formatted() == "018D-A4E9-CBB5-9C12");
    }
    {
        std::cout << "  Testing chrono64s with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(17, 1127U, 67, 818U, 1946U);
        auto tmp = Chrono64s::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64s::from_persona_units(tmp.get_timestamp(), 308ULL, 473ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32d::from_persona_units(tmp.get_timestamp(), 332ULL, 113ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32h::from_persona_units(tmp.get_timestamp(), 333ULL, 18ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32hy::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32hy::from_persona_units(tmp.get_timestamp(), 334ULL, 499ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32m::from_persona_units(tmp.get_timestamp(), 335ULL, 0ULL, p);
        assert(obj.value == 0xd92ab6ULL);
        assert(obj.formatted() == "00D9-2AB6");
    }
    {
        ...
        auto tmp = Chrono32mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32mo::from_persona_units(tmp.get_timestamp(), 336ULL, 501ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32q::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32q::from_persona_units(tmp.get_timestamp(), 337ULL, 502ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32tm::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32tm::from_persona_units(tmp.get_timestamp(), 338ULL, 7ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32w::from_persona_units(tmp.get_timestamp(), 339ULL, 504ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32y::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32y::from_persona_units(tmp.get_timestamp(), 340ULL, 505ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64cs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64cs::from_persona_units(tmp.get_timestamp(), 341ULL, 506ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64d::from_persona_units(tmp.get_timestamp(), 342ULL, 507ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64ds::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64ds::from_persona_units(tmp.get_timestamp(), 343ULL, 508ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64h::from_persona_units(tmp.get_timestamp(), 344ULL, 509ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64m::from_persona_units(tmp.get_timestamp(), 345ULL, 510ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64mo::from_persona_units(tmp.get_timestamp(), 346ULL, 511ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64ms::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64ms::from_persona_units(tmp.get_timestamp(), 347ULL, 512ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64s::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64s::from_persona_units(tmp.get_timestamp(), 348ULL, 513ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64us::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64us::from_persona_units(tmp.get_timestamp(), 349ULL, 2ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64w::from_persona_units(tmp.get_timestamp(), 350ULL, 515ULL, p);
        assert(obj.value == 0x161a4d3c3951c19ULL);
        assert(obj.formatted() == "0161-A4D3-C395-1C19");
    }
    {
        std::cout << "  Testing uchrono32bs with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(60, 1170U, 110, 861U, 0U);
        auto tmp = UChrono32bs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32bs::from_persona_units(tmp.get_timestamp(), 351ULL, 0ULL, p);
        assert(obj.value == 0x32e6014ULL);
        assert(obj.formatted() == "032E-6014");
    }
    {
        ...
        auto tmp = UChrono32d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32d::from_persona_units(tmp.get_timestamp(), 352ULL, 5ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32h::from_persona_units(tmp.get_timestamp(), 353ULL, 6ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32hy::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32hy::from_persona_units(tmp.get_timestamp(), 354ULL, 519ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32m::from_persona_units(tmp.get_timestamp(), 355ULL, 0ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32mo::from_persona_units(tmp.get_timestamp(), 356ULL, 521ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32q::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32q::from_persona_units(tmp.get_timestamp(), 357ULL, 522ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32tm::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32tm::from_persona_units(tmp.get_timestamp(), 358ULL, 11ULL, p);
        assert(obj.value == 0x2b6ef73ULL);
        assert(obj.formatted() == "02B6-EF73");
    }
    {
        ...
        auto tmp = UChrono32w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32w::from_persona_units(tmp.get_timestamp(), 359ULL, 12ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32y::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32y::from_persona_units(tmp.get_timestamp(), 360ULL, 525ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64cs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64cs::from_persona_units(tmp.get_timestamp(), 361ULL, 526ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64d::from_persona_units(tmp.get_timestamp(), 362ULL, 527ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64ds::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64ds::from_persona_units(tmp.get_timestamp(), 363ULL, 528ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64h::from_persona_units(tmp.get_timestamp(), 364ULL, 529ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64m::from_persona_units(tmp.get_timestamp(), 365ULL, 530ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64mo::from_persona_units(tmp.get_timestamp(), 366ULL, 531ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64ms::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64ms::from_persona_units(tmp.get_timestamp(), 367ULL, 532ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64s::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 368ULL, 533ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64us::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64us::from_persona_units(tmp.get_timestamp(), 369ULL, 22ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64w::from_persona_units(tmp.get_timestamp(), 370ULL, 535ULL, p);
        assert(obj.value == 0x2c08a3a8b0171ffULL);
        assert(obj.formatted() == "02C0-8A3A-8B01-71FF");
    }
    {
        std::cout << "  Testing chrono32bs with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(80, 1190U, 2, 881U, 0U);
        auto tmp = Chrono32bs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32bs::from_persona_units(tmp.get_timestamp(), 371ULL, 0ULL, p);
        assert(obj.value == 0x32e6014ULL);
        assert(obj.formatted() == "032E-6014");
    }
    {
        ...
        auto tmp = Chrono32d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32d::from_persona_units(tmp.get_timestamp(), 372ULL, 25ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32h::from_persona_units(tmp.get_timestamp(), 373ULL, 26ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32hy::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32hy::from_persona_units(tmp.get_timestamp(), 374ULL, 539ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32m::from_persona_units(tmp.get_timestamp(), 375ULL, 0ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32mo::from_persona_units(tmp.get_timestamp(), 376ULL, 541ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32q::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32q::from_persona_units(tmp.get_timestamp(), 377ULL, 542ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32tm::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32tm::from_persona_units(tmp.get_timestamp(), 378ULL, 15ULL, p);
        assert(obj.value == 0x15b77f3ULL);
        assert(obj.formatted() == "015B-77F3");
    }
    {
        ...
        auto tmp = Chrono32w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32w::from_persona_units(tmp.get_timestamp(), 379ULL, 32ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32y::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32y::from_persona_units(tmp.get_timestamp(), 380ULL, 545ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64cs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64cs::from_persona_units(tmp.get_timestamp(), 381ULL, 546ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64d::from_persona_units(tmp.get_timestamp(), 382ULL, 547ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64ds::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64ds::from_persona_units(tmp.get_timestamp(), 383ULL, 548ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64h::from_persona_units(tmp.get_timestamp(), 384ULL, 549ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64m::from_persona_units(tmp.get_timestamp(), 385ULL, 550ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64mo::from_persona_units(tmp.get_timestamp(), 386ULL, 551ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64ms::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64ms::from_persona_units(tmp.get_timestamp(), 387ULL, 552ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64s::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64s::from_persona_units(tmp.get_timestamp(), 388ULL, 553ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64us::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64us::from_persona_units(tmp.get_timestamp(), 389ULL, 10ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono64w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono64w::from_persona_units(tmp.get_timestamp(), 390ULL, 555ULL, p);
        assert(obj.value == 0x161a341d3917033ULL);
        assert(obj.formatted() == "0161-A341-D391-7033");
    }
    {
        std::cout << "  Testing uchrono32bs with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(100, 1210U, 22, 901U, 0U);
        auto tmp = UChrono32bs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32bs::from_persona_units(tmp.get_timestamp(), 391ULL, 0ULL, p);
        assert(obj.value == 0x32e6014ULL);
        assert(obj.formatted() == "032E-6014");
    }
    {
        ...
        auto tmp = UChrono32d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32d::from_persona_units(tmp.get_timestamp(), 392ULL, 45ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32h::from_persona_units(tmp.get_timestamp(), 393ULL, 14ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32hy::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32hy::from_persona_units(tmp.get_timestamp(), 394ULL, 559ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32m::from_persona_units(tmp.get_timestamp(), 395ULL, 0ULL, p);
        assert(obj.value == 0x1b2556cULL);
        assert(obj.formatted() == "01B2-556C");
    }
    {
        ...
        auto tmp = UChrono32mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32mo::from_persona_units(tmp.get_timestamp(), 396ULL, 561ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32q::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32q::from_persona_units(tmp.get_timestamp(), 397ULL, 562ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32tm::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32tm::from_persona_units(tmp.get_timestamp(), 398ULL, 3ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32w::from_persona_units(tmp.get_timestamp(), 399ULL, 52ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono32y::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono32y::from_persona_units(tmp.get_timestamp(), 400ULL, 565ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64cs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64cs::from_persona_units(tmp.get_timestamp(), 401ULL, 566ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64d::from_persona_units(tmp.get_timestamp(), 402ULL, 567ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64ds::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64ds::from_persona_units(tmp.get_timestamp(), 403ULL, 568ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64h::from_persona_units(tmp.get_timestamp(), 404ULL, 569ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64m::from_persona_units(tmp.get_timestamp(), 405ULL, 570ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64mo::from_persona_units(tmp.get_timestamp(), 406ULL, 571ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64ms::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64ms::from_persona_units(tmp.get_timestamp(), 407ULL, 572ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64s::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 408ULL, 573ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64us::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64us::from_persona_units(tmp.get_timestamp(), 409ULL, 30ULL, p);
    ...
    }
    {
        ...
        auto tmp = UChrono64w::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = UChrono64w::from_persona_units(tmp.get_timestamp(), 410ULL, 575ULL, p);
        assert(obj.value == 0x2c37e9977df5747ULL);
        assert(obj.formatted() == "02C3-7E99-77DF-5747");
    }
    {
        std::cout << "  Testing chrono32bs with 2023-05-20T10:30:00.123456Z" << std::endl;
        Persona p(120, 1230U, 42, 921U, 0U);
        auto tmp = Chrono32bs::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32bs::from_persona_units(tmp.get_timestamp(), 411ULL, 0ULL, p);
        assert(obj.value == 0x32e6014ULL);
        assert(obj.formatted() == "032E-6014");
    }
    {
        ...
        auto tmp = Chrono32d::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32d::from_persona_units(tmp.get_timestamp(), 412ULL, 65ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32h::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32h::from_persona_units(tmp.get_timestamp(), 413ULL, 2ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32hy::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32hy::from_persona_units(tmp.get_timestamp(), 414ULL, 579ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32m::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32m::from_persona_units(tmp.get_timestamp(), 415ULL, 0ULL, p);
        assert(obj.value == 0xd92ab6ULL);
        assert(obj.formatted() == "00D9-2AB6");
    }
    {
        ...
        auto tmp = Chrono32mo::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32mo::from_persona_units(tmp.get_timestamp(), 416ULL, 581ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32q::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32q::from_persona_units(tmp.get_timestamp(), 417ULL, 582ULL, p);
    ...
    }
    {
        ...
        auto tmp = Chrono32tm::from_iso_string("2023-05-20T10:30:00.123456Z");
        auto obj = Chrono32tm::from_persona_units(tmp.get_timestamp(), 418ULL, 7ULL, p);
    ...
    // Case 1
    {
        std::cout << "  Testing chrono32y with 2023-05-20T10:30:00.000000Z" << std::endl;
        Persona p(0, 0U, 0, 0U, 0U);
        auto tmp = Chrono32y::from_iso_string("2023-05-20T10:30:00.000000Z");
        auto obj = Chrono32y::from_persona_units(tmp.get_timestamp(), 4660ULL, 1383ULL, p);
        assert(obj.value == 0x1c0e1f7ULL);
        assert(obj.formatted() == "01C0-E1F7");
    }
    {
        std::cout << "  Testing chrono64s with 2023-05-20T10:30:00.000000Z" << std::endl;
        Persona p(0, 0U, 0, 0U, 0U);
        auto tmp = Chrono64s::from_iso_string("2023-05-20T10:30:00.000000Z");
        auto obj = Chrono64s::from_persona_units(tmp.get_timestamp(), 4660ULL, 1383ULL, p);
    ...
    // Epoch baseline
    {
        ...
        auto obj = UChrono64mo::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64mo::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64w::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64w::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64d::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64d::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64h::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64h::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64m::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64m::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64s::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64ds::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64ds::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64cs::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64cs::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64ms::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64ms::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono64us::from_persona_units(tmp.get_timestamp(), 123ULL, 8ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono64us::from_persona_units(tmp.get_timestamp(), 123ULL, 8ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32y::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono32y::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32hy::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
        assert(obj.value == 0x7178a6ULL);
        assert(obj.formatted() == "0071-78A6");
    }
    {
        ...
        auto obj = Chrono32hy::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32q::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
        assert(obj.value == 0xfc8a6ULL);
        assert(obj.formatted() == "000F-C8A6");
    }
    {
        ...
        auto obj = Chrono32q::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32mo::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
        assert(obj.value == 0x84fc4ULL);
    ...
    }
    {
        ...
        auto obj = Chrono32mo::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32w::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono32w::from_persona_units(tmp.get_timestamp(), 123ULL, 456ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32d::from_persona_units(tmp.get_timestamp(), 123ULL, 72ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono32d::from_persona_units(tmp.get_timestamp(), 123ULL, 72ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32h::from_persona_units(tmp.get_timestamp(), 123ULL, 8ULL, p);
        assert(obj.value == 0x272ULL);
    ...
    }
    {
        ...
        auto obj = Chrono32h::from_persona_units(tmp.get_timestamp(), 123ULL, 8ULL, p);
    ...
    }
    {
        ...
        auto obj = UChrono32tm::from_persona_units(tmp.get_timestamp(), 123ULL, 8ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono32tm::from_persona_units(tmp.get_timestamp(), 123ULL, 8ULL, p);
        assert(obj.value == 0x3aULL);
        assert(obj.formatted() == "0000-003A");
    }
    {
        ...
        auto obj = UChrono32m::from_persona_units(tmp.get_timestamp(), 123ULL, 0ULL, p);
    ...
    }
    {
        ...
        auto obj = Chrono32m::from_persona_units(tmp.get_timestamp(), 123ULL, 0ULL, p);
        assert(obj.value == 0x4ULL);
        assert(obj.formatted() == "0000-0004");
    }
    {
        std::cout << "  Testing uchrono32bs with 2020-01-01T00:00:00Z" << std::endl;
        Persona p(1, 456U, 2, 321U, 0U);
        auto tmp = UChrono32bs::from_iso_string("2020-01-01T00:00:00Z");
        auto obj = UChrono32bs::from_persona_units(tmp.get_timestamp(), 123ULL, 0ULL, p);
        assert(obj.value == 0x0ULL);
        assert(obj.formatted() == "0000-0000");
    }
    {
        std::cout << "  Testing chrono32bs with 2020-01-01T00:00:00Z" << std::endl;
        Persona p(1, 456U, 2, 321U, 0U);
        auto tmp = Chrono32bs::from_iso_string("2020-01-01T00:00:00Z");
        auto obj = Chrono32bs::from_persona_units(tmp.get_timestamp(), 123ULL, 0ULL, p);
        assert(obj.value == 0x0ULL);
        assert(obj.formatted() == "0000-0000");
    }
    ...
    {
        std::cout << "  Testing uchrono32bs with 2050-12-31T23:59:59Z" << std::endl;
        Persona p(1, 456U, 2, 321U, 0U);
        auto tmp = UChrono32bs::from_iso_string("2050-12-31T23:59:59Z");
        auto obj = UChrono32bs::from_persona_units(tmp.get_timestamp(), 123ULL, 0ULL, p);
        assert(obj.value == 0x1d27e43fULL);
        assert(obj.formatted() == "1D27-E43F");
    }
    {
        std::cout << "  Testing chrono32bs with 2050-12-31T23:59:59Z" << std::endl;
        Persona p(1, 456U, 2, 321U, 0U);
        auto tmp = Chrono32bs::from_iso_string("2050-12-31T23:59:59Z");
        auto obj = Chrono32bs::from_persona_units(tmp.get_timestamp(), 123ULL, 0ULL, p);
        assert(obj.value == 0x1d27e43fULL);
        assert(obj.formatted() == "1D27-E43F");
    }
    ...
    // Case 4
    {
        ...
        Persona p(0, 0U, 0, 0U, 0U);
        auto tmp = UChrono64s::from_iso_string("2020-01-01T00:00:00Z");
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 0ULL, 0ULL, p);
        assert(obj.value == 0x0ULL);
    ...
    // Case 5
    {
        ...
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 34937ULL, 3309ULL, p);
    ...
    // Case 6
    {
        ...
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 100ULL, 50ULL, p);
    ...
    // Case 7
    {
        ...
        auto obj = UChrono64s::from_persona_units(tmp.get_timestamp(), 221ULL, 983ULL, p);
...

    {
        ...
        try {
            ...
            if (msg.find("Timestamp underflow: Date is before Epoch (2020-01-01)") == std::string::npos) {
                std::cerr << "Expected error containing: Timestamp underflow: Date is before Epoch (2020-01-01), but got: " << msg << std::endl;
                assert(false);
            }
        }
    }
